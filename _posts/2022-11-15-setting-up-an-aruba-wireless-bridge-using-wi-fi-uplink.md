---
layout: post
title: Setting up an Aruba Wireless Bridge using Wi-Fi Uplink
date: 2022-11-15 13:11:48.000000000 -06:00
type: post
parent_id: '0'
published: true
password: ''
...
meta:
  ...
  _edit_last: '2'
  footnotes: ''
  _wpas_skip_publicize_19877085: '1'
  _bpp_element: body
  _bpp_repeat-x: 'yes'
  _bpp_repeat-y: 'yes'
...
Continuing with the configuration of the [WLAN station profile](https://www.arubanetworks.com/techdocs/CLI-Bank/Content/instant/wlan-sta-prof.htm) (for an SSID with enterprise auth). Your username will be in whatever format the NAC backend is expecting.
