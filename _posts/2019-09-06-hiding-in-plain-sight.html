...
date: 2019-09-06 23:13:34.000000000 -05:00
type: post
parent_id: '0'
published: true
password: ''
...
meta:
  ...
  _wpas_done_all: '1'
  _thumbnail_id: '1616'
  _wpas_mess: 'Blogged: Hiding Wireless Access Points In Plain Sight'
  _edit_last: '2'
  _bpp_element: body
  _bpp_repeat-x: 'yes'
  _bpp_repeat-y: 'yes'
...
After pondering the problem as well as observing drawings and renderings, I happened upon the architectural lighting elements in the plan that were mounted on each of the columns. I dug into the design of these and discovered that they were a pair of LED fixtures concealed inside some finish carpentry with a textured plastic surface. And most importantly, there was an empty space in the middle between the two light fixtures that measured about 20cm square by 40cm high, and centered approximately 8 feet off the floor. Not only was that low enough to keep the APs close to the clients, there was plenty of room to put in one of the [Ruckus H510](https://www.ruckuswireless.com/products/access-points/ruckus-indoor/ruckus-h510) Wall APs designed for the hospitality market (which I also currently have in my house running Unleashed, although they will soon make way for some of the [Aruba AP303H](https://www.arubanetworks.com/products/networking/access-points/303h/) units or their new [Instant On AP11D](https://www.arubainstanton.com/products/desk-wall/) counterpart). I'm a big fan of these in-wall units for many reasons.
...
![]({{site.baseurl}}/assets/2019/09/IMG_6291-768x1024.png)  
...
![]({{site.baseurl}}/assets/2019/09/IMG_6292-768x1024.png)  
...
![]({{site.baseurl}}/assets/2019/09/IMG_6293-768x1024.png)  
...
![]({{site.baseurl}}/assets/2019/09/IMG_6294-768x1024.png)  

The Ruckus H510 access point mounted on the bracket.

![]({{site.baseurl}}/assets/2019/09/IMG_6296-768x1024.png)  
...
![]({{site.baseurl}}/assets/2019/09/IMG_6295-768x1024.png)  
...
![]({{site.baseurl}}/assets/2019/09/IMG_6302-1024x768.png)  
