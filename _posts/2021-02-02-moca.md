---
layout: post
title: A nice cup of MoCA...
date: 2021-02-02 16:41:43.000000000 -06:00
type: post
parent_id: '0'
published: true
password: ''
...
author:
  ...
  first_name: Ian
  last_name: Beyer
permalink: "/2021/02/02/moca/"
image: "https://nerdian.ca/files/2021/02/AdobeStock_212578774-scaled.jpeg"
---
...
If you want a quick summary of how it works, device maker [GoCoax has a great rundown on their home page](https://www.gocoax.com/).
...
So I grabbed a [couple of MoCA adapters](https://amzn.to/3rgcepo) (and a [splitter](https://amzn.to/3tlwVSB)) from Amazon and tried it out in a couple of different configurations. Testing was done from a MacBook Pro connected to the network via Ethernet, and a [WLANpi](https://wlanpi.com) connected on the other end of a MoCA adapter.

![]({{site.baseurl}}/assets/2021/02/Screen-Shot-2021-02-02-at-4.59.24-PM-902x1024.png)  

The test setup.

The first thing I noticed is that these devices are truly "plug and play". I hooked one up to the coax in my office and the Ethernet side went into my switch. I then hooked 3 more up around the house, and on two of them, hooked up an access point, and on the third, the WLANpi. The access points came up and showed up in the controller just like they would on Ethernet (caveat: I had to power them externally). The WLANpi grabbed a DHCP address, and I started testing, using the [librespeed](https://librespeed.org) web speed test built into the WLANpi, as well as [iPerf3](https://iperf.fr), also built into the Pi.
...
![]({{site.baseurl}}/assets/2021/02/Screen-Shot-2021-02-02-at-10.13.04-AM-1024x582.png)![]({{site.baseurl}}/assets/2021/02/Screen-Shot-2021-02-02-at-10.13.20-AM-1024x100.png)

Next: The WLANpi at the other end of a 4-node MoCA 2.5 network:

![]({{site.baseurl}}/assets/2021/02/Screen-Shot-2021-02-02-at-10.19.40-AM-1024x601.png)![]({{site.baseurl}}/assets/2021/02/Screen-Shot-2021-02-02-at-10.21.00-AM-1024x96.png)
...
- [Kiwee Broadband](https://amzn.to/3tnMSrx), has a passthru port as well as a second Ethernet port.
- [GoCoax](https://amzn.to/2LeyQqO), another inexpensive option that works on v2.5.
