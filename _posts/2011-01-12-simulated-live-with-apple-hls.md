...
Wowza doesn't natively support pseudostreaming (although the [Stream Class](http://www.wowzamedia.com/forums/content.php?162-Server-side-publishing-using-the-Stream-class "Wowza Stream Class ") API does have some scheduling capability -- see [this post](http://nerdian.ca/2011/01/17/wowza-stream-class/ "Using the Wowza Stream Class")), so we needed some way of broadcasting recordings on a schedule. I could use the VT5 machine and the [Scheduler](http://www.youngmonkey.ca/hands/restaurant/plugins/Scheduler/index.html "VT5/Tricaster scheduler") to replay the recordings on a schedule, but the big downside is that it consumes local bandwidth, which is in short supply.
