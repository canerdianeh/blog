...
There are a lot of layers to this onion, so I put together a [block diagram](http://blog.ianbeyer.com/streaming/workflow) that links everything from the cameras to client.
